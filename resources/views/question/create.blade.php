...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            ...
            <form class="new_question" id="new_question" enctype="multipart/form-data"
                  action="/question/new" accept-charset="UTF-8" method="post">
{{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <ul class="main-action">
                                    ...
                                    <li>
                                        <a href="/question/list" class="btn-cancel"><i
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group ">
                                <label for="question_notes">Notes</label>
