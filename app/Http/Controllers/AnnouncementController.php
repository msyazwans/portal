    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($announcement->save()) {
                ...
                \DB::commit();
                return redirect('/announcement/list')->with('successMessage', 'Slider successfully added');
            } else {
                \DB::rollBack();
                return back()->withInput()->with('errorMessage', 'Slider not successfully added');
            }
        } catch (\Exception $e){
            return back()->withInput()->with('errorMessage', 'Slider not successfully added'.$e->getMessage());
        }
    }
