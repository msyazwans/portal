...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            ...
            <form class="new_link" id="new_link" enctype="multipart/form-data"
                  action="/link/new" accept-charset="UTF-8" method="post">
{{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <ul class="main-action">
                                    ...
                                    <li>
                                        <a href="/link/list" class="btn-cancel"><i
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <input class="form-control" type="file" name="link_background"
                                               id="link_background" value="{{ old('link_background') }}"/>
